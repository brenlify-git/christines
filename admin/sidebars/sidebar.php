    ...
    <aside id="sidebar" class="sidebar">
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <i class="bi bi-body-text"></i><span>Dynamic Content Control</span><i class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="SET-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="../content-control/logo-branding.php">
                            <i class="bi bi-people" style="font-size: 15px;"></i>
                            <span>Logo and Branding</span>
                        </a>
                    </li>
                </ul>
